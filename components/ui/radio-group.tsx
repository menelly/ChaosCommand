...
>(({ className, ...props }, ref) => {
  return (
    <RadioGroupPrimitive.Item
      ref={ref}
      className={cn(
        // 44x44 tap target via ::before overlay; visual dot unchanged. See checkbox.tsx.
        "relative aspect-square h-4 w-4 rounded-full border border-primary text-primary ring-offset-background",
