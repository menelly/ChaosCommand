      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
            ...
            return (
              <div className="border-2 border-destructive bg-destructive text-destructive-foreground rounded-lg p-4 space-y-3">
                ...
                <div className="ml-7 pt-2 border-t border-destructive-foreground/30 space-y-2">
                  ...
                  <p className="text-sm text-destructive-foreground"><strong>If this is in the PAST and resolved:</strong> these symptoms qualify as an emergency event — document carefully and follow up with your medical team.</p>
                </div>
                {measures.length > 0 && (
          ...
          <div className="flex gap-3 pt-4">
            ...
            <Button type="button" onClick={handleSave} className="flex-1"><Plus className="h-4 w-4 mr-2" />{editingEntry ? 'Update Event' : 'Save Respiratory Event'}</Button>
          </div>
        </div>
        </KeyboardAvoidingWrapper>
      </DialogContent>
