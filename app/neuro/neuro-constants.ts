...
export const EPISODE_TYPES = [
  ...
  { id: 'cramping', name: 'Spasticity / Cramping', icon: '🪢', description: 'Muscle cramps, spasms, stiffness, or velocity-dependent tightness (spasticity). Also tracked under MSK.', color: 'bg-warning/10 text-warning border-warning/20' },
